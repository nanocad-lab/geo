...
//	printf("Input raw %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
...
//                     std::cout << std::endl;
                ...
                for (int v_in=0; v_in<8; v_in++) {
                    ...
                    output[o_store_0_offset+v_in] += __builtin_popcount(output_pos_8_0[v_in]) - __builtin_popcount(output_neg_8_0[v_in]);
//                    printf("old, pw %d, i_out_size %d, w_cout %d, output %d\n", pw, i_out_size+v_in, w_cout, output[o_store_0_offset+v_in]);
//                    printf("Old Current output %d, pos %d, neg %d\n", output[o_store_0_offset+v_in], __builtin_popcount(output_pos_8_0[v_in]), __builtin_popcount(output_neg_8_0[v_in]));
                }
            }
        }
#endif
...
//                    printf("old pos %d, flatten_in %d, input %d, w pos %d, w neg %d\n", i_out_size+o_cout_step*w_cout, flatten_in, __builtin_popcount(input_v), __builtin_popcount(weight_pos_v), __builtin_popcount(weight_neg_v));
...
//                printf("old, pw %d, i_out_size %d, w_cout %d, output %d\n", pw, i_out_size, w_cout, output[i_out_size+o_cout_step*w_cout]);
//                printf("Old Current scalar output %d, pos %d, neg %d\n", output[i_out_size+o_cout_step*w_cout], __builtin_popcount(output_pos_c), __builtin_popcount(output_neg_c));
...
void matmul_outer_8(uint8_t* input, uint8_t* weight_pos, uint8_t* weight_neg, int32_t* output, int add_size, int inner_size, int cin_size, int cout_size) {
    int o_cout_step = cin_size;
    ...
    for(int pw=0; pw<add_size; pw++) {
        uint8_t* input_pw = input + pw * i_pw_step;
        uint8_t* weight_pos_pw = weight_pos + pw * w_pw_step;
        uint8_t* weight_neg_pw = weight_neg + pw * w_pw_step;
        int i_out_size = 0;

#ifdef __AVX512F__
        uint8_t output_pos_16_0[64];
        uint8_t output_pos_16_1[64];
        uint8_t output_pos_16_2[64];
        uint8_t output_pos_16_3[64];
        uint8_t output_neg_16_0[64];
        uint8_t output_neg_16_1[64];
        uint8_t output_neg_16_2[64];
        uint8_t output_neg_16_3[64];
        for (; i_out_size+63<cin_size; i_out_size+=64) {
            __m512i input_16_v;
            __m512i weight_pos_16_v;
            __m512i weight_neg_16_v;
            __m512i output_v_pos_16_0;
            ...
            for(; w_cout+3<w_flatten_step; w_cout+=4) {
                ...
                for(int flatten_in=0; flatten_in<inner_size; flatten_in++) {
                    input_16_v = _mm512_loadu_si512(input_pw + flatten_in*i_flatten_step + i_out_size);
                    weight_pos_16_v = _mm512_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout]);
                    output_v_pos_16_0 = _mm512_or_si512(output_v_pos_16_0, _mm512_and_si512(input_16_v, weight_pos_16_v));
                    weight_pos_16_v = _mm512_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout+1]);
                    output_v_pos_16_1 = _mm512_or_si512(output_v_pos_16_1, _mm512_and_si512(input_16_v, weight_pos_16_v));
                    weight_pos_16_v = _mm512_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout+2]);
                    output_v_pos_16_2 = _mm512_or_si512(output_v_pos_16_2, _mm512_and_si512(input_16_v, weight_pos_16_v));
                    weight_pos_16_v = _mm512_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout+3]);
                    output_v_pos_16_3 = _mm512_or_si512(output_v_pos_16_3, _mm512_and_si512(input_16_v, weight_pos_16_v));

                    weight_neg_16_v = _mm512_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout]);
                    output_v_neg_16_0 = _mm512_or_si512(output_v_neg_16_0, _mm512_and_si512(input_16_v, weight_neg_16_v));
                    weight_neg_16_v = _mm512_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout+1]);
                    output_v_neg_16_1 = _mm512_or_si512(output_v_neg_16_1, _mm512_and_si512(input_16_v, weight_neg_16_v));
                    weight_neg_16_v = _mm512_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout+2]);
                    output_v_neg_16_2 = _mm512_or_si512(output_v_neg_16_2, _mm512_and_si512(input_16_v, weight_neg_16_v));
                    weight_neg_16_v = _mm512_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout+3]);
                    output_v_neg_16_3 = _mm512_or_si512(output_v_neg_16_3, _mm512_and_si512(input_16_v, weight_neg_16_v));
                }
                _mm512_storeu_si512(output_pos_16_0, output_v_pos_16_0);
                _mm512_storeu_si512(output_pos_16_1, output_v_pos_16_1);
                _mm512_storeu_si512(output_pos_16_2, output_v_pos_16_2);
                ...
                for (int v_in=0; v_in<64; v_in++) {
                    ...
                    output[o_store_2_offset+v_in] += __builtin_popcount(output_pos_16_2[v_in]) - __builtin_popcount(output_neg_16_2[v_in]);
                    output[o_store_3_offset+v_in] += __builtin_popcount(output_pos_16_3[v_in]) - __builtin_popcount(output_neg_16_3[v_in]);
//                    output[o_store_0_offset+v_in] += popcount8b(output_pos_16_0[v_in]) - popcount8b(output_neg_16_0[v_in]);
//					output[o_store_1_offset+v_in] += popcount8b(output_pos_16_1[v_in]) - popcount8b(output_neg_16_1[v_in]);
//					output[o_store_2_offset+v_in] += popcount8b(output_pos_16_2[v_in]) - popcount8b(output_neg_16_2[v_in]);
//					output[o_store_3_offset+v_in] += popcount8b(output_pos_16_3[v_in]) - popcount8b(output_neg_16_3[v_in]);
                }
            }
            //Leftover channels
            for(; w_cout<w_flatten_step; w_cout++) {
...
//                     std::cout << std::endl;
                ...
                for (int v_in=0; v_in<64; v_in++) {
                    ...
                    output[o_store_0_offset+v_in] += __builtin_popcount((int)output_pos_16_0[v_in]) - __builtin_popcount((int)output_neg_16_0[v_in]);
//                    output[o_store_0_offset+v_in] += popcount8b(output_pos_16_0[v_in]) - popcount8b(output_neg_16_0[v_in]);
                }
            }
        }
...
#ifdef __AVX2__
        uint8_t output_pos_8_0[32];
        uint8_t output_pos_8_1[32];
        uint8_t output_pos_8_2[32];
        uint8_t output_pos_8_3[32];
        uint8_t output_neg_8_0[32];
        uint8_t output_neg_8_1[32];
        uint8_t output_neg_8_2[32];
        uint8_t output_neg_8_3[32];
        for (; i_out_size+31<cin_size; i_out_size+=32) {
            __m256i input_8_v;
            __m256i weight_pos_8_v;
            __m256i weight_neg_8_v;
            __m256i output_v_pos_8_0;
            ...
            for(; w_cout+3<w_flatten_step; w_cout+=4) {
                ...
                for(int flatten_in=0; flatten_in<inner_size; flatten_in++) {
                    input_8_v = _mm256_lddqu_si256((__m256i *)(input_pw + flatten_in*i_flatten_step + i_out_size));
                    weight_pos_8_v = _mm256_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout]);
                    output_v_pos_8_0 = _mm256_or_si256(output_v_pos_8_0, _mm256_and_si256(input_8_v, weight_pos_8_v));
                    weight_pos_8_v = _mm256_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout+1]);
                    output_v_pos_8_1 = _mm256_or_si256(output_v_pos_8_1, _mm256_and_si256(input_8_v, weight_pos_8_v));
                    weight_pos_8_v = _mm256_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout+2]);
                    output_v_pos_8_2 = _mm256_or_si256(output_v_pos_8_2, _mm256_and_si256(input_8_v, weight_pos_8_v));
                    weight_pos_8_v = _mm256_set1_epi8(weight_pos_pw[flatten_in*w_flatten_step + w_cout+3]);
                    output_v_pos_8_3 = _mm256_or_si256(output_v_pos_8_3, _mm256_and_si256(input_8_v, weight_pos_8_v));

                    weight_neg_8_v = _mm256_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout]);
                    output_v_neg_8_0 = _mm256_or_si256(output_v_neg_8_0, _mm256_and_si256(input_8_v, weight_neg_8_v));
                    weight_neg_8_v = _mm256_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout+1]);
                    output_v_neg_8_1 = _mm256_or_si256(output_v_neg_8_1, _mm256_and_si256(input_8_v, weight_neg_8_v));
                    weight_neg_8_v = _mm256_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout+2]);
                    output_v_neg_8_2 = _mm256_or_si256(output_v_neg_8_2, _mm256_and_si256(input_8_v, weight_neg_8_v));
                    weight_neg_8_v = _mm256_set1_epi8(weight_neg_pw[flatten_in*w_flatten_step + w_cout+3]);
                    output_v_neg_8_3 = _mm256_or_si256(output_v_neg_8_3, _mm256_and_si256(input_8_v, weight_neg_8_v));
                }
                _mm256_storeu_si256((__m256i *)output_pos_8_0, output_v_pos_8_0);
                _mm256_storeu_si256((__m256i *)output_pos_8_1, output_v_pos_8_1);
                ...
                for (int v_in=0; v_in<32; v_in++) {
                    ...
                    output[o_store_2_offset+v_in] += __builtin_popcount(output_pos_8_2[v_in]) - __builtin_popcount(output_neg_8_2[v_in]);
                    output[o_store_3_offset+v_in] += __builtin_popcount(output_pos_8_3[v_in]) - __builtin_popcount(output_neg_8_3[v_in]);
//                    output[o_store_0_offset+v_in] += popcount8b(output_pos_8_0[v_in]) - popcount8b(output_neg_8_0[v_in]);
//					output[o_store_1_offset+v_in] += popcount8b(output_pos_8_1[v_in]) - popcount8b(output_neg_8_1[v_in]);
//					output[o_store_2_offset+v_in] += popcount8b(output_pos_8_2[v_in]) - popcount8b(output_neg_8_2[v_in]);
//					output[o_store_3_offset+v_in] += popcount8b(output_pos_8_3[v_in]) - popcount8b(output_neg_8_3[v_in]);
                }
            }
            //Leftover channels
            for(; w_cout<w_flatten_step; w_cout++) {
...
//                     std::cout << std::endl;
                ...
                for (int v_in=0; v_in<32; v_in++) {
                    ...
                    output[o_store_0_offset+v_in] += __builtin_popcount((int)output_pos_8_0[v_in]) - __builtin_popcount((int)output_neg_8_0[v_in]);
//                    output[o_store_0_offset+v_in] += popcount8b(output_pos_8_0[v_in]) - popcount8b(output_neg_8_0[v_in]);
                }
            }
        }
        ...
        for (; i_out_size<i_flatten_step; i_out_size++) {
            int w_cout=0;
            uint8_t input_v;
            uint8_t weight_pos_v;
            uint8_t weight_neg_v;

            for(; w_cout<w_flatten_step; w_cout++) {
                uint8_t output_pos_c = 0;
                uint8_t output_neg_c = 0;
//                 std::cout << "Read weights" << std::endl;
                for(int flatten_in=0; flatten_in<inner_size; flatten_in++) {
//                     std::cout << "Input address " << pw * i_pw_step + flatten_in*i_flatten_step + i_out_size << std::endl;
                    input_v = input_pw[flatten_in*i_flatten_step + i_out_size];
...
//                     std::cout<< input_v << " " << weight_pos_v << " " << weight_neg_v << " " << __builtin_popcount(input_v & weight_pos_v) << " " << __builtin_popcount(input_v & weight_neg_v) << std::endl;
                ...
                output[i_out_size+o_cout_step*w_cout] += __builtin_popcount((int)output_pos_c) - __builtin_popcount((int)output_neg_c);
//                output[i_out_size+o_cout_step*w_cout] += popcount8b(output_pos_c) - popcount8b(output_neg_c);
//                 std::cout << i_out_size+o_cout_step*w_cout << " " << output[i_out_size+o_cout_step*w_cout] << std::endl;
//                 std::cout << "At the outputs" << std::endl;
//                 std::cout << pw << " " << i_out_size+o_cout_step*w_cout << " " << output[i_out_size+o_cout_step*w_cout] << std::endl;
            }
...
at::Tensor conv2d_add_partial_8(torch::Tensor input, torch::Tensor weight, int bit_length, at::IntArrayRef padding, at::IntArrayRef stride) {
    auto weight_size = weight.sizes();
    ...
    uint8_t* weight_pos_stream_new = new uint8_t [bit_packs * weight_size[0] * weight_size[1] * weight_size[2] * weight_size[3]];
    uint8_t* weight_neg_stream_new = new uint8_t [bit_packs * weight_size[0] * weight_size[1] * weight_size[2] * weight_size[3]];
    int pos_seed = 67;
    int neg_seed = 37;
...
//    #pragma omp parallel for
    for(int pack=0; pack<bit_packs; pack++) {
        uint8_t* weight_pos_pack = weight_pos_stream_new + pack * weight_size[0] * weight_size[1] * weight_size[2] * weight_size[3];
        uint8_t* weight_neg_pack = weight_neg_stream_new + pack * weight_size[0] * weight_size[1] * weight_size[2] * weight_size[3];
        for(int h_in=0; h_in<weight_size[3]; h_in++) {
            uint8_t* weight_pos_hin = weight_pos_pack + h_in * weight_size[0] * weight_size[1] * weight_size[2];
            uint8_t* weight_neg_hin = weight_neg_pack + h_in * weight_size[0] * weight_size[1] * weight_size[2];
            int flatten_in = 0;
            for(int c_in=0; c_in<weight_size[1]; c_in++) {
                uint8_t* weight_pos_cin = weight_pos_hin + c_in * weight_size[0] * weight_size[2];
                uint8_t* weight_neg_cin = weight_neg_hin + c_in * weight_size[0] * weight_size[2];
                for(int w_in=0; w_in<weight_size[2]; w_in++) {
                    uint8_t* weight_pos_win = weight_pos_cin + w_in * weight_size[0];
                    uint8_t* weight_neg_win = weight_neg_cin + w_in * weight_size[0];
...
//                            std::cout << "pos seed " << pos_seed_cur << " bit " << bit << std::endl;
...
//                            std::cout << "original " << c_out*weight_size[1]*weight_size[2]*weight_size[3] + c_in*weight_size[2]*weight_size[3] + w_in*weight_size[3] + h_in << " " << weight_pos_bin_point[c_out*weight_size[1]*weight_size[2]*weight_size[3] + c_in*weight_size[2]*weight_size[3] + w_in*weight_size[3] + h_in] << std::endl;
...
////    	std::cout << (int) weight_pos_stream_new[i] << " ";
//        std::cout << __builtin_popcount(int(weight_pos_stream_new[i])) << " ";
//    }
//    std::cout << std::endl;
//    std::cout << "New weight neg new" << std::endl;
//    for(int i=0; i<bit_packs * weight_size[0] * weight_size[1] * weight_size[2] * weight_size[3]; i++) {
////    	std::cout << (int) weight_neg_stream_new[i] << " ";
//        std::cout << __builtin_popcount(int(weight_neg_stream_new[i])) << " ";
//    }
//    std::cout << std::endl;
...
//        std::cout << "Batch " << batch << std::endl;
     ...
     // Input stream generation
        ...
        uint8_t* input_stream = new uint8_t [bit_packs * input_size[1] * input_size[2] * input_size[3]];
        uint8_t* input_point = new uint8_t [bit_packs * (input_size[2]-weight_size[2]+1) * (input_size[3]-weight_size[3]+1) * weight_size[1] * weight_size[2] * weight_size[3]];
        int input_seed = 0;
...
//            std::cout << "Pack " << pack << std::endl;
            uint8_t* input_stream_pack = input_stream + pack * input_size[1] * input_size[2] * input_size[3];
            uint8_t* input_point_pack = input_point + pack * (input_size[2]-weight_size[2]+1) * (input_size[3]-weight_size[3]+1) * weight_size[1] * weight_size[2] * weight_size[3];
            // Generation
...
//                        std::cout << h_in << std::endl;
            ...
            // im2col
            for(int h_in=0; h_in<weight_size[3]; h_in++) {
                uint8_t* input_point_hin = input_point_pack + h_in * (input_size[2]-weight_size[2]+1) * (input_size[3]-weight_size[3]+1) * weight_size[1] * weight_size[2];
                for(int flatten_in=0; flatten_in<weight_size[1] * weight_size[2]; flatten_in++) {
                    uint8_t* input_point_or = input_point_hin + flatten_in * (input_size[2]-weight_size[2]+1) * (input_size[3]-weight_size[3]+1);
...
//        std::cout << std::endl;
        // Computation
        matmul_outer_8(input_point, weight_pos_stream_new, weight_neg_stream_new, output_batch, add_size, inner_size, cin_size, cout_size);
        delete [] input_stream;
        delete [] input_point;
...
//                        printf("Old Pack %d, weight bin pos %d, value %d, stream %d\n", pack, 0, weight_pos_bin_point[0], weight_pos_win[0]);
                    }
//                    printf("Old Pack %d, weight bin pos %d, value %d, stream %d\n", pack, c_out*weight_size[1]*weight_size[2]*weight_size[3] + c_in*weight_size[2]*weight_size[3] + w_in*weight_size[3] + h_in, weight_pos_bin, weight_pos_win[c_out]);
                    if (h_in==weight_size[3]-1) {
                        pos_seed_arr[flatten_in] = pos_seed_cur;
                        neg_seed_arr[flatten_in] = neg_seed_cur;
                    }
...
//    std::cout << "New weight neg new" << std::endl;
//    for(int i=0; i<bit_packs * weight_size[0] * weight_size[1] * weight_size[2] * weight_size[3]; i++) {
//        std::cout << __builtin_popcount(weight_neg_stream_new[i]) << " ";
//    }
//    std::cout << std::endl;
...
//			for(int i=0; i+3<bit_packs*input_size[0]*input_size[1]*input_size[2]*input_size[3]; i+=4) {
//				printf("Old Input stream %d, %d, %d, %d\n", input_stream[i+0], input_stream[i+1], input_stream[i+2], input_stream[i+3]);
//			}
            // im2col
            for(int h_in=0; h_in<weight_size[3]; h_in++) {
...
//			printf("Old Input stream %d, %d, %d, %d\n", input_stream[i+0], input_stream[i+1], input_stream[i+2], input_stream[i+3]);
//		}
//        for(int i=0; i+3<bit_packs * (input_size[2]-weight_size[2]+1) * (input_size[3]-weight_size[3]+1) * weight_size[1] * weight_size[2] * weight_size[3]; i+=4) {
//        	printf("Old Input point %d, %d, %d, %d\n", input_point[i+0], input_point[i+1], input_point[i+2], input_point[i+3]);
//        }
//        printf("\n");
        // Computation
        ...
        for(int c_out=0; c_out<weight_size[0]; c_out++) {
            ...
            for(int c_in=0; c_in<weight_size[1]; c_in++) {
                ...
                for(int w_in=0; w_in<weight_size[2]; w_in++) {
                    ...
                    for(int h_in=0; h_in<weight_size[3]; h_in++) {
//                        std::cout << "c_out " << h_in * weight_size[0] * weight_size[1] * weight_size[2] + c_in * weight_size[0] * weight_size[2] + w_in * weight_size[0] + c_out << std::endl;
//                        std::cout << "original " << c_out*weight_size[1]*weight_size[2]*weight_size[3] + c_in*weight_size[2]*weight_size[3] + w_in*weight_size[3] + h_in << " " << w_pos_split[c_out][c_in][w_in][h_in] << std::endl;
...
//    for(int i=0; i<bit_packs*weight_size[0]*weight_size[1]*weight_size[2]*weight_size[3]; i++) {
//     std::cout << __builtin_popcount(weight_pos_point[i]) << " " ;
//    }
//    std::cout << std::endl;
//    std::cout << "Weight neg point" << std::endl;
//    for(int i=0; i<bit_packs*weight_size[0]*weight_size[1]*weight_size[2]*weight_size[3]; i++) {
//     std::cout << __builtin_popcount(weight_neg_point[i]) << " " ;
//    }
//    std::cout << std::endl;
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("conv2d_add_partial_8", &conv2d_add_partial_8, "SC forward conv2d partial bin add (8-bit version)");
